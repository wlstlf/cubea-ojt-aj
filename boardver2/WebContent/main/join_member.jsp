...
/* 	function idChkFunc(id){ // html 
	...
	function validate(){
		 ...
		 var id_regular = /^[a-zA-Z0-9]{6,12}$/;   // 일단 test로 길이 줄여둠 
		 var pwd_regular = /^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z0-9\d!@#$%^&*]{10,15}$/;  // 일단 test로 길이 줄여둠 
         ...
         */
         ...
         // 체크되면 form 전송
         joinFrm.action = "join_action.jsp";
         joinFrm.submit();
...
<body>
	...
	<form name="joinFrm" onsubmit="return validate()" action="" method="post">  <!-- join_action.jsp -->
		...
		<table class="logintb">
			<tr>
				...
				<!-- <td><input type="button" value="중복확인" name="dupChk" onclick="idDupchk();" /><span id="ck"></span></td> -->
			</tr>			
			<tr>
				<td></td>
